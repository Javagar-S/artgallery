...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["contact_submit"])) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'java2943s@gmail.com'; // Replace with your Gmail
        $mail->Password = 'lgyi vkzh iwos gagy';   // Replace with your Google App Password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        $mail->setFrom($email, $name); // Sender
        $mail->addAddress('6363043386js@gmail.com'); // Recipient
...
function downloadImage() {
  ...
  link.download = `Image_${currentIndex + 1}.jpg`; // Use backticks for template literals
